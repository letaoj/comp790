...
public class AGUIClientComposerAndLauncher {
  ...
  protected Map<SimpleList, OTManager> otManagers;
  ...
  public void composeAndLaunch(String[] args) {
    ...
    otManagers = new HashMap<SimpleList, OTManager>();
    otManagers.put(history, new OTManager(args[2], false));
    otManagers.put(topic, new OTManager(args[2], false));
