...
public class AModifiedSimpleList<ElementType> extends ASimpleList<ElementType> {
  ...
  protected void traceRemove(int anIndex, ElementType anElement) {
    ListEditMade.newCase(OperationName.DELETE, anIndex, anElement, tag, this);
  }

  public void notifyRemove(List<ListObserver<ElementType>> observers, int index,
      ElementType newValue) {
    ListEditNotified.newCase(OperationName.DELETE, index, newValue, tag, this);
    for (ListObserver<ElementType> observer : observers)
